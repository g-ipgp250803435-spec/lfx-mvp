...
export const mockAnnouncements: Announcement[] = [
  { announcement_id: "ANN-001", title: { bm: "Permohonan iKES bagi bulan Ogos dibuka", en: "August iKES applications are open" }, content: { bm: "Pelajar yang memerlukan bantuan sementara boleh mengemukakan permohonan melalui portal LFX.", en: "Students requiring temporary assistance may submit an application through the LFX portal." }, category: "iKES", attachment_url: "", publish_date: "2026-07-30", created_by: "treasurer@ipg.edu.my", responsible_officer: "Naib Bendahari Agung" },
